...
<template>
 <mu-container>
  ...
  <div class="demotext" v-if="active1 === 0">
      <div class="top">
          <span>
              授课方式
  ...
  <div class="demotext" v-if="active1 === 1">
      <div class="top">
          <span>
              课程筛选
          <mu-select full-width :solo='true'>
          ...
          <span>
              附近
             <mu-select full-width :solo='true'>
                <mu-option v-for="city,index in citys4" :key="city" :label="city" :value="city"></mu-option>
            </mu-select>
          </span>
      ...
      <div class="boxContent">
            <div class="content" v-for="data in goodsData" :key="data.id" @click="goOrganDetail(data.id)">
          <img :src="data.imgSrc" alt="" class="left">
          <div class="center">
              <span class="title">{{data.title}}</span>
              <div class="star">
                   <Rate v-model="data.stars" :disabled='true' allow-half/> 
              </div>
              <span class="average">人均￥{{data.averge}}</span>
              <span class="add">{{data.address}}</span>
          </div>
          <div class="right">
              <div class="hot">热度{{data.hot}}</div>
     ...
     border-top: .0625rem solid #EEEEEE;
      ...
      .content{
         ...
         .right{
             ...
             .distance{font-size: .6875rem;color: #666666;margin-top: .75rem;}
         }
      }
  }
</style>