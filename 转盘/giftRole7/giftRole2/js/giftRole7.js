$(function(){
//页面访问统计
	var pageAccesURl ='https://cloud.miduoxing.cn/pageAccess/v2/pageAccessMore?pageName=giftRole7&&channel=lvtudiandian'
		$.ajax({
						type:"post",
						url:pageAccesURl,
...
//中奖了的弹框上 前往第三方点击
  $('.giftZZ .banner .toGetGift').click(function(){
  		//前往第三方的统计
	var btnAccessUrl1 = "https://cloud.miduoxing.cn/pageAccess/v2/btnAccessMore?pageName=giftRole7&&btnName="+aa.words+"&&channel=lvtudiandian"
			$.ajax({
			type:"post",
			url:btnAccessUrl1,
			contentType : "application/json",
...
$(".noChanse .banner .toGetGift").click(function(){
    	  ...
    	  var btnAccessUrl3 = "https://cloud.miduoxing.cn/pageAccess/v2/btnAccessMore?pageName=giftRole7&&btnName="+"我的奖品按钮"+"&&channel=lvtudiandian"
			$.ajax({
			type:"post",
			url:btnAccessUrl3,
			contentType : "application/json",
...
//我的奖品 按钮点击
    $(".myGift").click(function(){
    	  var btnAccessUrl2 = "https://cloud.miduoxing.cn/pageAccess/v2/btnAccessMore?pageName=giftRole7&&btnName="+"我的奖品按钮"+"&&channel=lvtudiandian"
			$.ajax({
			type:"post",
			url:btnAccessUrl2,
			contentType : "application/json",
