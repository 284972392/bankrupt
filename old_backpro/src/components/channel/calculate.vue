<template>
    <div class="home">
        <div class="title">划算管理</div>
        <div class="search">
            搜索
            <Input v-model="value" placeholder="划算编号/划算名称/商家名称" style="width: 26%;" size="large"></Input>
            优惠类别
    ...
    <div class="table">
        ...
        <tr class="btn_tr">
            <td>
                ...
                <Button @click="submitBtn()" style="margin-right: 10px;">提交</Button>
    ...
    export default {
                                ...
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                             ...
                                             this.$router.push({path:'/checkBargain',
                                                query: {
        ...
        methods:{
            ...
            handlePageSize(value){
                  this.pageNum = value;
                      this.get(this.allUrl.findBargainPage,{page:value,rows:9,status:this.nowStatus,type:this.nowType}).then((res)=>{
            ...
            AllTask(){
                ...
                this.shows = 1
                this.model1 = ''
                  this.get(this.allUrl.findBargainPage,{page:1,rows:9}).then((res)=>{
                this.data1 = res.data.rows;        
                if(res.data.total){ 
                 ...
                 this.get(this.allUrl.countBargain).then((res)=>{
            ...
            toSubmit(){
                ...
                this.nowStatus = 1
                this.shows = 2
                 this.get(this.allUrl.findBargainPage,{page:1,rows:9,status:1,type:this.nowType}).then((res)=>{
                                this.data1 = res.data.rows;        
                                if(res.data.total){
                                            this.totalNum = res.data.total          
                                        }else{
            ...
            Putaway(){
                this.nowStatus = 4
                this.shows = 3
                 this.get(this.allUrl.findBargainPage,{page:1,rows:9,status:4,type:this.nowType}).then((res)=>{
                                this.data1 = res.data.rows;        
                                if(res.data.total){
                                            this.totalNum = res.data.total          
                                        }else{
            ...
            OnGoing(){
                this.nowStatus = 5
                this.shows = 4
                 this.get(this.allUrl.findBargainPage,{page:1,rows:9,status:5,type:this.nowType}).then((res)=>{
                                this.data1 = res.data.rows;        
                                if(res.data.total){
                                            this.totalNum = res.data.total          
                                        }else{
            ...
            Pause(){
                this.nowStatus = 6
                this.shows = 5
                 this.get(this.allUrl.findBargainPage,{page:1,rows:9,status:6,type:this.nowType}).then((res)=>{
                                this.data1 = res.data.rows;        
                                if(res.data.total){
                                            this.totalNum = res.data.total          
                                        }else{
            ...
            Soldout(){
                this.nowStatus = 7
                this.shows = 6
                 this.get(this.allUrl.findBargainPage,{page:1,rows:9,status:7,type:this.nowType}).then((res)=>{
                                this.data1 = res.data.rows;        
                                if(res.data.total){
                                            this.totalNum = res.data.total          
                                        }else{
            ...
            toAudit(){
                this.nowStatus = 2
                this.shows = 7
                 this.get(this.allUrl.findBargainPage,{page:1,rows:9,status:2,type:this.nowType}).then((res)=>{
                                this.data1 = res.data.rows;        
                                if(res.data.total){
                                            this.totalNum = res.data.total          
                                        }else{
            ...
            returned(){
                this.nowStatus = 3
                this.shows = 8
                 this.get(this.allUrl.findBargainPage,{page:1,rows:9,status:3,type:this.nowType}).then((res)=>{
                                this.data1 = res.data.rows;        
                                if(res.data.total){
                                            this.totalNum = res.data.total          
                                        }else{
            ...
            check(params){
                console.log(params)
                this.$store.state.discountId = params.row.id;
                                this.$router.push({path:'/viewBargain',
                                            query: {
                                                tenantId:params.row.tenantId
                                            }
                                         })
            ...
            //点击修改
            recompose(params){
                  this.$router.push({path:'/changeBargain',
                                query: {
                                    id:params.row.id,
                                    tenantId:params.row.tenantId
                                }
             ...
             subOk(){
                  this.$http({
                        ...
                        if(response.data.ret == 'ok'){
                            ...
                            this.$router.push({path:'/subBargainOk',
                                            query: {
                   ...
                   this.$http({
                        ...
                        if(response.data.ret == 'ok'){
                            this.$Message.success('删除成功');
                             this.get(this.allUrl.findBargainPage,{page:this.pageNum,rows:9}).then((res)=>{
                                this.data1 = res.data.rows;        
                                if(res.data.total){
                                            this.totalNum = res.data.total          
                                        }else{
            ...
            search(){
                 if(this.value==''&&this.model1==''){
                    ...
                    this.get(this.allUrl.findBargainPage,{page:1,rows:9,name:this.value,type:this.model1}).then((res)=>{
                                this.data1 = res.data.rows;        
                                if(res.data.total){
                                            this.totalNum = res.data.total          
                                        }else{
                          ...
                          this.get(this.allUrl.countBargain,{type:this.model1}).then((res)=>{
                             this.discountNum = res.data.data;
                        })  
                }
