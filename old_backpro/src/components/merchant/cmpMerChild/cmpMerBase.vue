<template>
	<div class="cmpMerBase">
		<div class="merBack">
			...
			<div class="zhiZhao"><span>公司logo</span><img :src=base.headPic alt="" /></div>
			<div class="zhiZhao"><span>营业执照</span><img :src=base.idCardPic alt="" /></div>
		</div>
		<div class="merPro">
...
<script>
	export default{
		...
		mounted(){
//			this.id = this.id_;
			this.id = localStorage.getItem("merSherchId")
			console.log(this.id)
