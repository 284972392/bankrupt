<template>
    <div class="readDiscount">
        <div class="title">发布优惠  <Button type="primary" class="submit" @click="submit">提交</Button></div>
        <div class="secTitle">商户基本信息</div>
          ...
          <div class="secTitle">卡券信息</div>
                 <Row>
                    <Col span="7" offset="1">
                        ...
                        <FormItem label="卡券详情样式">
                           <img :src="this.formItem.cardDetailPic" alt="">
                        </FormItem>                    
                        <FormItem label="领取人数">
                    ...
                    <Col span="7" offset="2">
                        ...
                        <FormItem label="卡券列表样式">
                            <img :src="this.formItem.cardListPic" alt="">
                        </FormItem>   
                        <FormItem label="优惠简介">
             ...
             <div v-for="(data,index) in this.formItem.linkVoList" v-if="formItem.receiveMode=='多个链接'">
                 <div class="proHeader">
             ...
             <div v-if="formItem.receiveMode=='单链接不可跳转'||formItem.receiveMode=='单链接可跳转'">
                   <Row>
                    <Col span="7">
                      <FormItem label="链接地址">
                          {{formItem.linkVoList[0].linkAddress}}
                        </FormItem>   
                    </Col>
                    <Col span="7" offset="2">
                    </Col>
            ...
            <div style="width:100%;"><Button type="primary" class="change" @click="change">修改</Button></div>
